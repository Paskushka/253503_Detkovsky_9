...
import Museum.main.models as mod
from django.test import TestCase
from django.urls import reverse
from django.contrib.auth import get_user_model
from Museum.myzei import models


class LoginViewTest(TestCase):
    def setUp(self):
        self.user = models.CustomUser.objects.create_user(email='testuser@gmail.com', password='12345678', username='testuser')
    ...
    def test_login_view(self):
        ...
        self.assertTemplateUsed(response, 'main/main_info.html')


class NewsModelTest(TestCase):
    def setUp(self):
        self.news = mod.News.objects.create(title='Test News', content='This is a test news content')

    def test_news_content(self):
        self.assertIsInstance(self.news, mod.News)
...
class ReviewModelTest(TestCase):
    def setUp(self):
        self.user = models.CustomUser.objects.create_user(email='testuser@gmail.com', password='12345678', username='testuser@gmail.com')
        self.client = models.Client.objects.create(user=self.user, company_name='as', legal_entity=True)
        self.review = mod.Review.objects.create(author=self.client, rate=8, content='This is a test review')

    def test_review_content(self):
        self.assertIsInstance(self.review, mod.Review)
...
class PromocodeModelTest(TestCase):
    def setUp(self):
        self.promocode = mod.PromoCode(name="3434", code="3536", discount_percentage=10)

    def test_promocode_content(self):
        self.assertIsInstance(self.promocode, mod.PromoCode)
...
class AnswerModelTest(TestCase):
    def setUp(self):
        self.answer = mod.Answer.objects.create(content='This is a test answer')

    def test_answer_content(self):
        self.assertIsInstance(self.answer, mod.Answer)
...
class VacancyModelTest(TestCase):
    def setUp(self):
        ...
        self.vacancy = mod.Vacancy.objects.create(employee_position=self.employee_position, number_of_this_position=2,
                                              vacancy_description='This is a test vacancy')

    def test_vacancy_content(self):
        self.assertIsInstance(self.vacancy, mod.Vacancy)
...
class BonusModelTest(TestCase):
    ...
    def setUp(self):
        self.bonus = mod.Bonus.objects.create(
    ...
    def test_bonus_creation(self):
        self.assertIsInstance(self.bonus, mod.Bonus)
...
class CompanyModelTest(TestCase):
    ...
    def setUp(self):
        self.company = mod.Company.objects.create(
            name="Tech Corp",
    ...
    def test_company_creation(self):
        self.assertIsInstance(self.company, mod.Company)
...
class CompanyStoryModelTest(TestCase):
    ...
    def setUp(self):
        self.company_story = mod.CompanyStory.objects.create(
            title="Test Story",
    ...
    def test_company_story_creation(self):
        self.assertTrue(isinstance(self.company_story, mod.CompanyStory))
    ...
    def test_company_story_blank_date(self):
        company_story_blank_date = mod.CompanyStory.objects.create(
...
class QuestionModelTest(TestCase):
    ...
    def setUp(self):
        self.answer = mod.Answer.objects.create(
            content="This is an answer"
        )
        self.question = mod.Question.objects.create(
    ...
    def test_question_creation(self):
        self.assertTrue(isinstance(self.question, mod.Question))
    ...
    def test_question_blank_date(self):
        question_blank_date = mod.Question.objects.create(
...
class OrderFormTest(TestCase):
    def setUp(self):
        ...
        self.client = models.Client.objects.create(user=self.user, company_name='as', legal_entity=True)
        self.promocode_instance = mod.PromoCode.objects.create(name="PROMO10", code="PROMO10", discount_percentage=10)
        self.bonus_instance = mod.Bonus.objects.create(name="BONUS20", code="PROMO10", discount_percentage=20)
